...
export declare class Samples {
     ...
     */
    update(voiceId: string, sampleId: string, request?: ElevenLabs.voices.pvc.BodyUpdatePvcVoiceSampleV1VoicesPvcVoiceIdSamplesSampleIdPost, requestOptions?: Samples.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddVoiceResponseModel>;
    private __update;
    /**
     ...
     */
    delete(voiceId: string, sampleId: string, requestOptions?: Samples.RequestOptions): core.HttpResponsePromise<ElevenLabs.DeleteVoiceSampleResponseModel>;
    private __delete;
}
