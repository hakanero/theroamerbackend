...
export declare const AstNotEqualsOperatorNodeLeft: core.serialization.Schema<serializers.AstNotEqualsOperatorNodeLeft.Raw, ElevenLabs.AstNotEqualsOperatorNodeLeft>;
export declare namespace AstNotEqualsOperatorNodeLeft {
    type Raw = AstNotEqualsOperatorNodeLeft.AndOperator | AstNotEqualsOperatorNodeLeft.BooleanLiteral | AstNotEqualsOperatorNodeLeft.DynamicVariable | AstNotEqualsOperatorNodeLeft.EqOperator | AstNotEqualsOperatorNodeLeft.GtOperator | AstNotEqualsOperatorNodeLeft.GteOperator | AstNotEqualsOperatorNodeLeft.Llm | AstNotEqualsOperatorNodeLeft.LtOperator | AstNotEqualsOperatorNodeLeft.LteOperator | AstNotEqualsOperatorNodeLeft.NeqOperator | AstNotEqualsOperatorNodeLeft.NumberLiteral | AstNotEqualsOperatorNodeLeft.OrOperator | AstNotEqualsOperatorNodeLeft.StringLiteral;
